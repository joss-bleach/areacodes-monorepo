...
export function CookieBanner() {
  ...
  if (messageState === "confirmation") {
    return (
      <div
        className="fixed bottom-0 left-0 right-0 z-50 border-t bg-background px-4 py-3 shadow-lg"
        role="region"
      ...
      <div className="mx-auto w-full max-w-[1200px]">
        <div className="flex flex-col gap-3">
          <div className="flex flex-col gap-2">
            <h2 className="text-base font-semibold">Cookies on Areacodes</h2>
            <div className="flex flex-col gap-2">
              <p className="text-sm">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <a
              href="#"
              className="inline-flex h-8 items-center justify-center rounded-md px-3 text-sm font-medium text-primary underline-offset-4 hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
            >
              View cookies
            </a>
          </div>
